...
const workflowData = [
  {
    title: 'Hello World でページを表示する',
    text:
      'まずは文字を表示するだけの超簡単なアプリを作る',
  },
  {
    title: '単純な従業員管理アプリを作る',
    text:
      '従業員の登録、一覧の表示、情報の更新、削除をひと通りおこなえるアプリを作る。',
  },
  {
    title: '爆速に動く従業員管理アプリにする',
    text:
      'ページ読み込みの待ち時間がほとんどなく、ユーザにリッチな操作体験をもたらせる\n\
      モダンなアプリの作り方を学ぶ。',
  },
  {
    title: 'みんなが使えるようにアプリを公開する',
    text:
      '自分の PC で使うだけではなく、誰でも使えるようにクラウドサーバにアプリを公開する。',
  },
];
    ...
    <Box as="section" sx={styles.workflow}>
      <Container>
        <BlockTitle
          ...
          heading="どうすれば自分が作りたい Web アプリができるかが学べる"
        />
